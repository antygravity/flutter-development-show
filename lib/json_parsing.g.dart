  ...
  Iterable serialize(Serializers serializers, Article object,
    ...
    final result = <Object>[
      ...
      serializers.serialize(object.kids,
          specifiedType:
              const FullType(ListBuilder, const [const FullType(int)])),
      'url',
...
class _$Article extends Article {
  ...
  _$Article._(
    ...
    if (dead == null) throw new BuiltValueNullFieldError('Article', 'dead');
    if (parent == null) throw new BuiltValueNullFieldError('Article', 'parent');
    if (poll == null) throw new BuiltValueNullFieldError('Article', 'poll');
    if (kids == null) throw new BuiltValueNullFieldError('Article', 'kids');
    if (url == null) throw new BuiltValueNullFieldError('Article', 'url');
...
class ArticleBuilder implements Builder<Article, ArticleBuilder> {
  ...
  ListBuilder<int> get kids => _$this._kids;
  ...
  ListBuilder<int> get parts => _$this._parts;
